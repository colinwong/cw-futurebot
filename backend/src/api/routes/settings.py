...
SETTING_DEFAULTS = {
    ...
    "risk_mode": {
        ...
        "type": "str",
        "label": "Risk Mode",
        "tooltip": "Manual: use fixed values below. Auto: calculate max position and daily loss from your live account balance. Auto adjusts as your account grows or shrinks.",
    },
    "max_position_size": {
        "default": str(app_config.max_position_size),
        "type": "int",
        "label": "Max Position Size (manual)",
        "tooltip": "Fixed maximum contracts per symbol. Only used in Manual mode.",
    },
    "daily_loss_limit": {
        "default": str(app_config.daily_loss_limit),
        "type": "float",
        "label": "Daily Loss Limit $ (manual)",
        "tooltip": "Fixed maximum daily loss. Only used in Manual mode.",
    },
    "auto_max_position_pct": {
        "default": "40",
        "type": "float",
        "label": "Max Margin Usage % (auto)",
        "tooltip": "In Auto mode: max percentage of buying power to use for positions per symbol. At 40% with $10K buying power, allows ~2-3 MES contracts. Adjusts as your balance changes.",
    },
    "auto_daily_loss_pct": {
        "default": "2.5",
        "type": "float",
        "label": "Daily Loss Limit % (auto)",
        "tooltip": "In Auto mode: max daily loss as percentage of account balance. At 2.5% with $10K balance = $250 daily limit. Scales automatically with your account.",
    },
    "default_stop_ticks": {
